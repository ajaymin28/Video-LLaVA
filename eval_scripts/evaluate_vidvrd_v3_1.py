...
predicate_classes_wo_underscore = ["jump right", "stand left", "taller", "jump past", "jump behind", "stand front", "sit next to", 
"sit behind", "sit front", "next to", "front", "stand next to", "stand behind", "walk right", "walk next to", 
"walk left", "walk past", "walk front", "walk behind", "faster", "larger", "stand with", "stand right", "walk with", 
"walk toward", "walk away", "stop right", "stop beneath", "stand above", "ride", "run beneath", "sit above", 
"sit beneath", "sit left", "sit right", "walk above", "behind", "watch", "hold", "feed", "touch", "right", "left", 
"follow", "move front", "move beneath", "chase", "run left", "run right", "lie next to", "lie behind", "play", 
"move behind", "jump beneath", "fly with", "fly past", "move right", "move left", "swim front", "swim left", 
"move with", "jump front", "jump left", "swim right", "swim next to", "jump next to", "swim with", "move past", 
"bite", "pull", "jump toward", "fight", "run front", "run behind", "sit inside", "drive", "lie front", "stop behind", 
"lie left", "stop left", "lie right", "creep behind", "creep above", "beneath", "above", "fall off", "stop front", 
"run away", "run next to", "away", "jump away", "fly next to", "lie beneath", "jump above", "lie above", "walk beneath", 
"stand beneath", "move toward", "toward", "past", "move away", "run past", "fly behind", "fly above", "fly left", 
"lie with", "creep away", "creep left", "creep front", "run with", "run toward", "creep right", "creep past", 
"fly front", "fly right", "fly away", "fly toward", "stop above", "stand inside", "kick", "run above", "swim beneath", 
"jump with", "lie inside", "move above", "move next to", "creep next to", "creep beneath", "swim behind", 
...
def get_model_output(file,predicates,batch_of_frames=None):
    sg_outputs = {
        # "objects_list": "",
        "triplets": ""
    }
...
if __name__=="__main__":
    ...
    for val_id_idx, val_id in enumerate(val_ids):
        ...
        for frame_block_index, overall_annot in enumerate(overall_annotations):
            ...
            outputs_unclean = get_model_output(file=file,predicates=predicate_classes_wo_underscore,batch_of_frames=Block_frame_ids)
